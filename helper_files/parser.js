 ...
 *    .mul(i) = mul(i)            (int or string)                 number or attribute to multiply roll by
 *    .div(i) = div(i)            (int or string)                 number or attribute to divide roll by (DEFAULT ROUNDED DOWN)
 *  
 * 
...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { codeLine: peg$parsecodeLine };
  var peg$startRuleFunction = peg$parsecodeLine;
  ...
  var peg$f1 = function(rep, r, a, m, d) {
  ...
  var peg$f4 = function(w, i) {
        if ((w && i) || (!w && !i)) return null;
        if (w) return w;
        if (i) return i;
    };
  var peg$f5 = function(digits) { return parseInt(digits.join(""), 10); };
  var peg$f6 = function(char, chars) { return char + chars.join("") };
  var peg$f7 = function(word) {return word.join("")};
  var peg$currPos = 0;
  var peg$savedPos = 0;
